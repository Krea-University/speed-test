...
echo "   Run: ./configure-domain.sh your-domain.com"
echo ""
echo "🔑 API Testing:"
echo "   Use X-API-Key: demo-api-key-2025 for testing API endpoints"
echo ""
echo "🧪 Test endpoints:"
echo "   curl \${SERVER_URL:-http://localhost:8080}/ping"
echo "   curl \${SERVER_URL:-http://localhost:8080}/ip"
echo "   curl -H 'X-API-Key: demo-api-key-2025' \${SERVER_URL:-http://localhost:8080}/api/tests"
